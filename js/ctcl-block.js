...
registerBlockType('ctc-lite/ctc-lite-checkout-block', {
    ...
    save: ({ attributes }) => {
        return el('div', null,
            el('div', { className: 'ctcl-checkout' }, '[ctcl-checkout]',
                ...
                el('form', { id: 'ctcl-checkout-from', },
                    ...
                    el('div', { className: "ctcl-co-name-container" },
                        ...
                        el('input', { className: 'ctcl-co-name', type: 'text', required: true }),
                    ),
                    el('div', { className: 'ctcl-address-row' },
                        el('div', { className: 'ctcl-address-col' },
                        ...
                        el('div', { className: 'ctcl-address-col' },
                            el('label', { htmlFor: "ctcl-co-add-1", className: "ctcl-co-add-2-label" }, __("Street Address 2 :", 'ctc-lite')),
                    ...
                    el('div', { className: 'ctcl-address-row' },
                        el('div', { className: 'ctcl-address-col' },
                            ...
                            el('input', { id: 'ctccl-co-zip', className: 'ctccl-co-zip', required: true, name: "checkout-zip-code", type: 'text', }),
                        ),
                        el('div', { className: 'ctcl-address-col' },
                    ...
                    el('div', { className: 'ctcl-address-row' },
                        ...
                        el('textarea', { id: 'ctcl-co-instruction', className: 'ctcl-co-instruction', required: true, name: "checkout-special-instruction", cols: '50', rows: '10', }),
                    ),
                    el('div', { className: 'ctcl-shipping-options' },
                        el('h5', { className: 'ctcl-shipping-options-header' }, __('Shipping Options', 'ctc-lite')),
